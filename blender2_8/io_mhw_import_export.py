...
def register():
    ...
    bpy.utils.register_class (MIRRORMESH_geometry_by_table_lr)
    bpy.utils.register_class (MIRRORMESH_geometry_by_table_rl)
...
def unregister():
    ...
    bpy.utils.unregister_class (MIRRORMESH_geometry_by_table_lr)
    bpy.utils.unregister_class (MIRRORMESH_geometry_by_table_rl)
