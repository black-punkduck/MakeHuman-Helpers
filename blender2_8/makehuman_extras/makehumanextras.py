...
class MHE_PT_MakeHumanExtrasPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if obj is None or obj.type != "MESH":
            ...
            sett.label(text="Mirror table", icon="TOOL_SETTINGS")
            ...
            if hasattr(obj, "MhMeshType") and hasattr(obj, "MhObjectType")  and obj.MhObjectType == "Basemesh":
                sett.operator("mhe.predef", text="Assign table from MakeTarget")

            select = layout.box()
            select.label(text="Selection", icon="SELECT_SET")
